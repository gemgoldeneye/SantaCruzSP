...
/* ============================================================
   PRANGKISA — shared UI built on the Santa Cruz Sanggunian design system
...
/* ---------- DIGITAL MTOP CREDENTIAL (navy = Santa Cruz brand primary) ---------- */
...
function SealChip({ size = 40 }: { size?: number }) {
  ...
  return (
    ...
    >
      <Image src="/santa-cruz-seal.png" alt="Seal of the Municipality of Santa Cruz" width={inner} height={inner} />
    </span>
  );
}
...
export function CredentialCard({
  ...
  return (
    <div className="overflow-hidden rounded-xl bg-[#0e1b34] text-white shadow-sm ring-1 ring-black/10">
