/* ============================================================
   ...
   Tricycle Franchise & MTOP module · SP Sanggunian App
   ============================================================ */
...
export type PayMethodId = "gcash" | "maya" | "card" | "bank";
...
export interface Application {
  ...
  zone: string;
  toda: string;
  /** Applicant identity captured in the apply wizard (Step 2). */
  ...
  resolution?: string;
  orNo?: string;
  /** How the order of payment was settled (set at the payment step). */
  payMethod?: PayMethodId;
  /** Checklist upload state, keyed by DOCS[].id. Hydrated from the server. */
