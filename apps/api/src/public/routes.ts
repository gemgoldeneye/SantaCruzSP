// Public transparency reads — UNAUTHENTICATED. Exposes only citizenAccess:'public'
// projections: published projects + enacted ordinances. Anonymous citizens browse
// these without an OTP session (the sync pull requires a session, so these
// dedicated endpoints back the public portal home).
