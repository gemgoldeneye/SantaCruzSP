...
import type { Go, RouteParams, Store } from "./types";
        ...
        <div className="lg:sticky lg:top-4">
          <div className="rounded-xl border bg-card p-5 shadow-sm">
            ...
            <p className="mt-2 text-xs text-muted-foreground">
              Fees per the Tricycle Franchising Ordinance / Santa Cruz Revised Revenue Code (illustrative — confirm before go-live).
            </p>
            <Button
              size="lg"
